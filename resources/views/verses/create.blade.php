...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header fw-bold fs-5">➕ Add New Verse</div>
            <div class="card-body">
                <form method="POST" action="{{ route('verses.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="text" rows="4"
                                  ...
                                  placeholder="Enter the verse text...">{{ old('text') }}</textarea>
                        @error('text') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="d-flex gap-2">
                        <a href="{{ route('verses.index') }}" class="btn btn-outline-secondary">Cancel</a>
                        <button type="submit" class="btn btn-primary">Add Verse</button>
                    </div>
                </form>
            </div>
        </div>
